...
public class CourseViewHolder extends RecyclerView.ViewHolder {
    ...
    CourseViewHolder(View itemView) {
        ...
        ivComment.setImageDrawable(ContextCompat.getDrawable(ivComment.getContext(), R.drawable.comment_icon));
    ...
    public void bindCourse(Course course){
        ...
        GlideApp.with(ivProfile).load(course.getProfileImageURL()).fitCenter().into(ivProfile);
    }
}
